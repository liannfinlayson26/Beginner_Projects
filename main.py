...
def deal_card():
    ...
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
    random_card_deck = random.choice(cards)
...
#only 2 cards: ace + 10) and return 0 instead of the actual score.
# 0 will represent a blackjack in our game.

    #if 11 in cards and 10 in cards and len(cards) ==2:
    if sum(cards) == 21 and len(cards) == 2:
        return 0
#Hint 8: #Hint 8: Inside calculate_score() check for an 11 (ace).
...
def play_game():
    ...
    while not is_game_over:
        ...
        print(f"	The computer card: {computer_cards[0]}")
        ...
        #If no, then the game has ended.    
            user_should_deal = input(f"Type 'y' to continue playing with, or type 'n' to pass: ")
    ...
    #         print("Is the turn of the computer!")
    #         computer_cards.append(deal_card())
    #         computer_score = calculate_score(computer_cards)
    #         revision()
    #         #comparision
    ...
    def compare(user_score, computer_score):
        if user_score == computer_score:
            ...
            return ("BUST! you lose. The computer wins!")
        elif user_score == 0 or computer_score >21:
            return ("BLACKJACK! you win! Congratulations!")
        else:
            max_number = max(user_score, computer_score)
            if user_score > computer_score:
                return(f"BLACKJACK!  YOU WIN! with {max_number}")
            else:
                return (f"BUST! The winner is computer with {max_number}")
